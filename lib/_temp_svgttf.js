(function() {
  ...
  this.walk_font_outlines = function*(me, source) {
    ...
    var advance, cid, cid_hex, cids, d, description, fallback_pathdata, font, fontnick, glyph, i, len, metrics, path, pathdata_json, progress_count, relpath;
    ({fontnick, path, relpath} = source);
    //.........................................................................................................
    ...
    cids = (function() {
      var results = [];
      for (var i = 0x0000; i <= 65535; i++){ results.push(i); }
      return results;
    }).apply(this);
/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
//.........................................................................................................
    for (i = 0, len = cids.length; i < len; i++) {
      ...
      if ((d == null) || (d.pathdata === fallback_pathdata)) {
        continue;
      }
