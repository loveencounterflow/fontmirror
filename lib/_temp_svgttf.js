(function() {
  ...
  this.walk_font_outlines = function*(me, source) {
    ...
    /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
    var SVGTTF_font, XXX_advance_scale_factor, advance, cid, cid_hex, d, description, fallback_pathdata, fontnick, glyph, i, metrics, otjsfont, path, pathdata, pathdata_json, progress_count, ref, relpath, results;
