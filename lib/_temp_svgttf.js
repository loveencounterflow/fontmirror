(function() {
  ...
  this.walk_font_outlines = function*(me, source) {
    ...
    /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
    var SVGTTF_font, XXX_advance_scale_factor, advance, cid, cid_hex, d, description, fallback_pathdata, glyph, i, metrics, otjsfont, outline_json, pathdata, progress_count, ref, results;
    description = {
...
//.........................................................................................................
    results = [];
    for (cid = i = 0x4e00; i <= 20223; cid = ++i) {
      ...
      results.push((yield `${cid_hex},${glyph},${outline_json}\n`));
    }
    return results;
  };
