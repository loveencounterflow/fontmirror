(function() {
  ...
  this.walk_font_outlines = function*(me, source) {
    ...
    /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
    var SVGTTF_font, XXX_advance_scale_factor, advance, cid, cid_hex, d, description, fallback_pathdata, glyph, i, metrics, otjsfont, pathdata, pathdata_json, progress_count, ref, results;
    description = {
      fontnick: source.fontnick,
      path: source.path
    };
    yield `${jr(description)}\n`;
    if ((otjsfont = this._open_font(source.path, source.relpath)) == null) {
      return;
    }
...
//.........................................................................................................
    results = [];
    for (cid = i = 0x4e00; i <= 19970; cid = ++i) {
      ...
      results.push((yield `${cid_hex},${glyph},${advance},${pathdata_json}\n`));
    }
    return results;
  };
