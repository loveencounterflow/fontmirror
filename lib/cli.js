(function() {
  ...
  this.cli = function() {
    return new Promise((done) => {
      ...
      //.........................................................................................................
      app.command('link-all-sources').description("rewrite links to fonts in target/all").option('-d --dry', "show what links would be written").action(async(d) => {
        var dry, ref;
        has_command = true;
  ...
  if (require.main === module) {
    (async() => {
      await this.cli();
      return help("^fontmirror/cli@43892^ terminating.");
    })();
  }
