(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.link_all_sources = async function(dry = false) {
    var FONTMIRROR, XXXXXXXX_count, cache, extensions, fontnick, i, idx, j, len, len1, link_location, links_home, mkdirp, name, new_fontnick, partitioner, path, paths, paths_by_fontnicks, pattern, short_path, source_name, source_path, target_path;
    FONTMIRROR = require('..');
